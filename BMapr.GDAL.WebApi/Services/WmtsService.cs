...
namespace BMapr.GDAL.WebApi.Services
{
    ...
    public class WmtsService
    {
        ...
        public static ActionResult HandleRequest(IMemoryCache cache, string project, string queryString, Config config)
        {
        ...
        public static ActionResult GetWmsRequestFromWmtsGetTile(IMemoryCache cache, Config config, string project, Capabilities capabilities, string service, string request, string version, string layer, string style, string format, string tileMatrixSet, string tileMatrix, int tileRow, int tileCol)
        {
            ...
            var response = OgcService.Process(cache, OgcService.RequestType.Get, queryString, "", config, project);
