...
namespace BMapr.GDAL.WebApi.Services
{
    public class WfsService
    {
        ...
        public static ActionResult Transaction(IMemoryCache cache, Config config, string project, string contentBody)
        {
            ...
            if (transaction.Insert != null)
            {
                ...
                foreach (var insert in transaction.Insert)
                {
                    ...
                    {
                        if (xmlNode.LocalName.ToLower() == "geometry" || xmlNode.LocalName.ToLower() == "shape" || xmlNode.LocalName.ToLower() == "msgeometry")
                        {
            ...
            if (transaction.Update != null)
            {
                ...
                foreach (var update in transaction.Update)
                {
                    ...
                    foreach (var property in update.Property)
                    {
                        ...
                        if (name.ToLower() == "geometry" || name.ToLower() == "shape" || name.ToLower() == "msgeometry")
                        {
